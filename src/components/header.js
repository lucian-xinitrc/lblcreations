...
const Header = () => {
    return (
        <>
        <section className="dark:bg-[#d9d9d9] bg-white text-black h-auto px-5 py-20 sm:p-25 content-center">
            <div className="py-8 px-4 mx-auto max-w-screen-xl place-self-center text-center lg:py-16 lg:px-12">
                <a href="#" className="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
                    <span className="text-xs bg-primary-600 rounded-full text-black dark:text-white px-4 py-1.5 mr-3">New</span> <span className="text-sm font-medium">Our brand new printers are ready!</span> 
